...
export const PAYMENT_PLANS = {
  weekly: {
    ...
    price: '$7.99',
    period: 'per week',
    checkoutUrl: 'https://checkout.dodopayments.com/buy/pdt_0NY4WWfzpoe7TaaVa7MPa?quantity=1',
    productId: 'pdt_0NY4WWfzpoe7TaaVa7MPa',
  },
  yearly: {
    name: 'Yearly Pro',
    price: '$39.99',
    period: 'per year',
    checkoutUrl: 'https://checkout.dodopayments.com/buy/pdt_0NY4WXOt0LVbL3MPY8HuR?quantity=1',
    productId: 'pdt_0NY4WXOt0LVbL3MPY8HuR',
    savings: 'Save 90%',
  },
  lifetime: {
    ...
    price: '$199.99',
    period: 'one-time',
    checkoutUrl: 'https://checkout.dodopayments.com/buy/pdt_0NY4WYX9oEAwLgjqjmaGC?quantity=1',
    productId: 'pdt_0NY4WYX9oEAwLgjqjmaGC',
    savings: 'Best Value',
  },
} as const;
