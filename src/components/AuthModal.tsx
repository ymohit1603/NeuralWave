...
import { Brain, Loader2, Mail, AlertCircle, MailCheck } from 'lucide-react';
  ...
  if (showEmailSent) {
    return (
      <Dialog open={open} onOpenChange={handleClose}>
        <DialogContent className="sm:max-w-md" hideCloseButton ariaTitle="Check Your Email">
          <div className="flex flex-col items-center text-center py-6">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Click the link in the email to verify your account and start using NeuralWave.
            </p>
